...
"""
For my final code, I did a major overhaul of my original code as I believed that the original cannot work due to errors in the for loop
of the application of the prime list. Because of that, I reverted back to my original design as I think an efficiency of O(n^3/2) is not
unacceptable for the program considering 10000 is not as big as other numbers. My final answer was proven correct, which return a value
of 104731, which is what others have got in their answers.
"""
